...
- [`imsight-mentality-mgr`](imsight-mentality-mgr/SKILL.md): Manage named mentality catalogs, project-wide principle selections, independent agent-memory overrides, and effective-rule recall; explicitly review existing code with bundled Brooks diagnostics.
