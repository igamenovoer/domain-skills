...
| Manage a Rigor Control flavor | Identify the entry as, for example, `Rigor Control / product-showcase`, with that flavor's own selected IDs, priority, and catalog. Do not merge its state with another assurance flavor. |
